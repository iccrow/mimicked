...
public class Config
{
    private static final ModConfigSpec.Builder BUILDER = new ModConfigSpec.Builder().comment("General settings for the Mimicked mod.");

    public static final ModConfigSpec.LongValue TIMEOUT = BUILDER.push("thresholds")
    ...
    public static final ModConfigSpec.BooleanValue DISABLE_SELF = BUILDER
            .comment("Disables hearing yourself.")
            .define("disableSelf", false);

    public static final ModConfigSpec.BooleanValue PREFER_SERVER_SIDE = BUILDER
    ...
    public static final ModConfigSpec.ConfigValue<List<? extends String>> HOST_WHITELIST = BUILDER
            ...
            .defineListAllowEmpty("hostWhitelist", List::of, () -> "", Config::validateEntityName);

    public static final ModConfigSpec.ConfigValue<List<? extends String>> OVERDRIVE_HOSTS = BUILDER
            ...
            .comment("Add the entity's id to the list. An example list: [\"minecraft:zombie\", \"minecraft:piglin\"]")
            .comment("You can also put an entry of \"@modid\" to whitelist all entities from a mod. Example: [\"@mimicked\"]")
            .defineListAllowEmpty("overdriveHosts", List::of, () -> "", Config::validateEntityName);

    public static final ModConfigSpec.DoubleValue OVERDRIVE_SPARSITY = BUILDER
    ...
    public static final ModConfigSpec.BooleanValue DEBUG = BUILDER.pop().pop().push("debug")
        ...
        try {
            return obj instanceof final String name && (
                    name.startsWith("@") && ModList.get().isLoaded(name.substring(1)) ||
                            BuiltInRegistries.ENTITY_TYPE.containsKey(ResourceLocation.parse(name))
            );
        } catch (Exception e) {
            return false;
        }
