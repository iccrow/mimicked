...
public class FracturedTempoSFX implements SFX {
    ...
    public FracturedTempoSFX() {
        ...
        this.minVariance = SFXConfig.FRACTURED_TEMPO_SFX.VARIANCE_MIN.get();
        this.maxVariance = SFXConfig.FRACTURED_TEMPO_SFX.VARIANCE_MAX.get();
    }
    ...
    public float[] apply(float[] samples) {
        return Shifter.fracturedTempo(samples, this.fxRatio, this.concentration, this.minVariance, this.maxVariance);
    }
    ...
    public static class Config {
        ...
        public final ModConfigSpec.DoubleValue VARIANCE_MIN;
        public final ModConfigSpec.DoubleValue VARIANCE_MAX;
